...
const CONFIG = {
  github: {
    username: 'KathirRPA', // Your GitHub org/user name. (This is the only required config)
  },
  /**
  ...
  social: {
    ...
    skype: '',
    telegram: '',
    website: 'https://kathirrpa.github.io/',
    phone: '',
    email: 'kathirvelsaminathan.99@gmail.com',
  },
  resume: {
    fileUrl:
